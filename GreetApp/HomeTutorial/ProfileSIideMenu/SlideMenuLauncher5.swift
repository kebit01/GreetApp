...
class SlideMenuLauncher5: NSObject, UICollectionViewDataSource,
...
//        cv.backgroundColor = UIColor.soothingBlue
    ...
    let settings = [
        ...
        Setting(headerText: "Cancel", imageName: "x-mark")
    ]
    ...
    let cell = collectionView.dequeueReusableCell(withReuseIdentifier: slideId, for: indexPath) as! SlideMenuCell5
...
//    }
    ...
    override init() {
        ...
        collectionView.register(SlideMenuCell5.self, forCellWithReuseIdentifier: slideId)
