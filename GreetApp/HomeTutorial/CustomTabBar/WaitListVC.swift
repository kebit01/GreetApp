...
//    }()
    ...
    let topOrderContainerView: UIView = {
        let topOrder = UIView()
        topOrder.backgroundColor = .purple
    ...
    let bottomOrderContainerView: UIView = {
        ...
        bottomOrder.backgroundColor = .red
...
//            ordertext.backgroundColor = nil
            ordertext.backgroundColor = .yellow
    ...
    //            ordertext.backgroundColor = nil
                bOrdertext.backgroundColor = .cyan
        ...
        lazy var detialsButton: UIButton = {
            ...
            detials.backgroundColor = UIColor.blue
...
//        navigationController?.navigationBar.prefersLargeTitles = true
                navigationItem.title = "Wait List"
...
//        detialsButton.bottomAnchor.constraint(equalTo: view.bottomAnchor).isActive = true
    ...
    //        code for a single viewController
