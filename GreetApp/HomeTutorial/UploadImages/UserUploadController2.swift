...
//
//private let uUImageView: UIImageView = {
//    let uUIv = UIImageView()
//    uUIv.backgroundColor = UIColor.red
////        uUIv.image = UIImage(named: "add-user" )
//    uUIv.layer.cornerRadius = 22
//    uUIv.layer.masksToBounds = true
//    uUIv.contentMode = .scaleAspectFit
//    uUIv.translatesAutoresizingMaskIntoConstraints = false
//    uUIv.clipsToBounds = true
//    uUIv.isUserInteractionEnabled = true
//    return uUIv
//}()
//
//// Took this off to allow pageController Image Array to work properly need this for Add image button
//let uUImageView2: UIImageView = {
//    let uUIv2 = UIImageView()
//    uUIv2.backgroundColor = UIColor.orange
//    //              uUIv2.image = UIImage(named: "Tacos1" )
//    uUIv2.layer.cornerRadius = 22
//    uUIv2.layer.masksToBounds = true
//    uUIv2.contentMode = .scaleAspectFill
//    uUIv2.translatesAutoresizingMaskIntoConstraints = false
//    uUIv2.constrainHeight(260)
//    return uUIv2
//}()
//
//class UserUploadController2: LBTAFormController, UITextFieldDelegate, UITextViewDelegate {
//    
...
//        changeButton.pulse()
//        
//        uUImageView2.image = transferImage
//        
//    }
//    
...
//        let cTf = UITextField()
//        cTf.attributedPlaceholder = NSAttributedString (string: "Status", attributes: [NSAttributedString.Key.foregroundColor: UIColor.lightGray])
//        cTf.layer.borderWidth = 1
//        cTf.layer.borderColor = UIColor.black.cgColor
//        cTf.backgroundColor = .white
//        cTf.textAlignment = .center
//        return cTf
//    }()
//    
//    let status = ["Yes", "No"]
...
//        //        dTf.leftViewMode = .always
//        //        dTf.leftView = UIView(frame: CGRect(x: 0, y: 0, width: 5, height: 0))
//        //        dTf.textColor = .black
...
//        uUImageView.image = transferImage
//        uUImageView2.image = transferImage
//        
...
//        print("handleUpload2")
//        
//        NotificationCenter.default.post(name: Notification.Name("text"), object: productTf.text)
//        NotificationCenter.default.post(name: Notification.Name("text2"), object: priceTf.text)
//        NotificationCenter.default.post(name: Notification.Name("text3"), object: statusTf.text)
//        NotificationCenter.default.post(name: Notification.Name("text4"), object: descriptionTf.text)
//        NotificationCenter.default.post(name: Notification.Name("text5"), object: categoryTf.text)
//        NotificationCenter.default.post(name: Notification.Name("text6"), object: lengthTf.text)
//        NotificationCenter.default.post(name: Notification.Name("text7"), object: widthTf.text)
//        NotificationCenter.default.post(name: Notification.Name("text8"), object: heightTf.text)
//
//
...
//        navigationController?.pushViewControllerFromRight(controller: viewController)
//        viewController.transferImage = uUImageView2.image!
//        viewController.navImageIsUploaded()
//        
//        //allows code to be added into a new class in firebase
...
//        let userid = user?.uid
//        
//        //this is the URL string for uploaded image
//        let urlString2 = UserDefaults.standard.value(forKey: "url2") as! String?
//                
//        guard let key = ref.child("posts").childByAutoId().key else { return }
//        let post = ["uid": userid,
//                    "product_img": urlString2,
//                    "product_name": pUNameLabel.text,
//                    "product_price": pUPriceLabel.text,
////                    "product_name": text] as [String : Any]
//                    "product_status": statusTf.text,
//                    "product_description": descriptionTf.text,
//                    "product_category": categoryTf.text,
//                    "product_length": lengthTf.text,
//                    "product_width": widthTf.text,
//                    "product_height": heightTf.text,
//                    "timestamp": [".sv":"timestamp"]] as [String: Any]
////        let childUpdates = ["/posts/\(key)": post,
////                            "/users-posts/\(userid!)/\(key)/": post]
//        let childUpdates = ["/users-posts/\(userid!)/\(key)/": post]
////        let childUpdates = ["/posts/\(key)": post]
...
//    func setupViews() {
//        
//        //        formContainerStackView.translatesAutoresizingMaskIntoConstraints = false
//        //        formContainerStackView.topAnchor.constraint(equalTo: view.topAnchor, constant: 10).isActive = true
//        formContainerStackView.axis = .vertical
//        formContainerStackView.spacing = 5
//        formContainerStackView.layoutMargins = .init(top: 5, left: 24, bottom: 0, right: 24)
//        
//        formContainerStackView.addArrangedSubview(uUImageView2)
//        
...
//        switch product {
//        case "":
//            print("WHERE IS THIS BITCH GOING")
...
//        switch price {
//        case "" :
//            print("WHERE IS THIS BITCH GOING2")
...
//        switch category {
//        case "" :
//            print("WHERE IS THIS BITCH GOING4")
...
//        switch length {
//        case "" :
//            print("WHERE IS THIS BITCH GOING5")
...
//        switch width {
//        case "" :
//            print("WHERE IS THIS BITCH GOING6")
...
//        switch height {
//        case "" :
//            print("WHERE IS THIS BITCH GOING7")
...
//        switch description {
//        case "" :
//            print("WHERE IS THIS BITCH GOING3")
//            descriptionTf.resignFirstResponder()
//            statusTf.becomeFirstResponder()
//        default:
//            print("Bitch add some text3")
...
//            
//            self.view.frame = CGRect(x: 0, y: -188, width: self.view.frame.width, height: self.view.frame.height)
//            
//        }, completion: nil)
//    }
//    
//    @objc func keyboardDismiss1() {
//        print("KeyboardDismiss1")
//        
...
//extension UserUploadController2: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
//    
...
//        }
//        
//        uUImageView2.image = secondImage
//        
//    }
//    
//}
//
////status selection new: yes/no
//extension UserUploadController2: UIPickerViewDataSource, UIPickerViewDelegate {
//    
